...
$sql = 'INSERT INTO bbs_table(id, bbs, date, place, machine, image, created_at, updated_at) VALUES(NULL, :bbs, :date, :place, :machine, :image, now(), now())';

$stmt = $pdo->prepare($sql);
$stmt->bindValue(':bbs', $bbs, PDO::PARAM_STR);
